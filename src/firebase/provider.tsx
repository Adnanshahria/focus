...
import { useUserLogic as useUserHook, UserAuthState } from './hooks/use-user';
...
const FirebaseUserProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    // We can safely cast because FirebaseProvider ensures context is set
    const userAuthState = useUserHook((baseContext as FirebaseContextState).auth);
